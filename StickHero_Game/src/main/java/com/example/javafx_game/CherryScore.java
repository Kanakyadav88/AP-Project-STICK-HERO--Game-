...
//        cherryCount.setText(String.valueOf(SceneController.getCherrycount()));
//    }
//    public void updateScoreCount(){
//        scoreValue.setText(String.valueOf(SceneController.getCurrScore()));
//    }
}
